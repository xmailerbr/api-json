...
# Definindo a URL do endpoint da API xmailer para envio de emails
...
data = """
{
    ...
    "emailDestino": ["postmaster@xmailer.com.br", "dev@xmailer.com.br"],  # Lista de emails destinatários
